...
export class MultiChainWallet implements IKeyringWallet {
  ...
  readonly supportedAssets = [KeyringAssetType.WREX,KeyringAssetType.ETH,KeyringAssetType.ERC20];
  ...
  deserialize (data: KeyringWalletSerialized) {
    ...
    this.keyrings = [
      HdKeyring.create(this.mnemonic, BIP_44_PATHS.WREX_PATH, KeyringNetwork.WREX, 1),
