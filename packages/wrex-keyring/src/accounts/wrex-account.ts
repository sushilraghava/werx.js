...
export class WrexAccount extends EcdsaAccount implements IKeyringAccount {

  decimals = 8;
  network = KeyringNetwork.WREX;
  hasTokenSupport = false;
  supportedAssets = [KeyringAssetType.WREX];
  tokens = null;//wrexAssetLibrary.getDefaultAssets();
