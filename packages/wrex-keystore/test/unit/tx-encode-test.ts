...
const ENCODED_TX = '240WREX2rVZNxft1DFyegDqEuTHV7uS27j1qb2CbepnS40WREX5A4s8whzjwz2y9VxjLQgL9bwtUjuRzvemTGFd100101010';
...
describe('TX-Encode', () => {
  ...
  it('encoded tx', () => {
    ...
    expect(encodedTx).to.equal('240WREX4bQGdnDJ5okVdsdtvJzBwQoPGjLNzN7HC1CBV40WREX4EqbfJNSYZDDfs7AUzofotJzZXeRYgHaGZ6jQ55839064fa640ea8a562d61540904f4a1658a04bb6a7238d02d49ece14ef8b2fefff539624010141f465cec34dfd8');
  });
