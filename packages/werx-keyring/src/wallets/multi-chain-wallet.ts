...
export class MultiChainWallet implements IKeyringWallet {
  ...
  readonly supportedAssets = [KeyringAssetType.WERX,KeyringAssetType.ETH,KeyringAssetType.ERC20];
  ...
  deserialize (data: KeyringWalletSerialized) {
    ...
    this.keyrings = [
      HdKeyring.create(this.mnemonic, BIP_44_PATHS.WERX_PATH, KeyringNetwork.WERX, 1),
