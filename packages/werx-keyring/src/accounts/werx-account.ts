...
export class WerxAccount extends EcdsaAccount implements IKeyringAccount {

  decimals = 8;
  network = KeyringNetwork.WERX;
  hasTokenSupport = false;
  supportedAssets = [KeyringAssetType.WERX];
  tokens = null;//werxAssetLibrary.getDefaultAssets();
